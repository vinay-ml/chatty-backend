...
export class UserCache extends BaseCache {
  ...
  public async getUserFromCache(userId: string): Promise<IUserDocument | null> {
    try {
      ...
      response.createdAt = new Date(Helpers.parseJson(`${response.createdAt}`) as string);
      ...
      response.notifications = Helpers.parseJson(`${response.notifications}`) as IUserDocument['notifications'];
      response.social = Helpers.parseJson(`${response.social}`) as IUserDocument['social'];
